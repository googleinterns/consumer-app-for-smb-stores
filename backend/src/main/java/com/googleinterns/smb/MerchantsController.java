...
public class MerchantsController {
    ...
    public void sendBid(@RequestBody Merchant merchantRequest) throws Exception {
        ...
        DatabaseReference totalRating = mDatabase.child("MerchantRatings").child(merchantRequest.getMerchantId())
                .child("TotalRatings");
        DatabaseReference numberOfOrders = mDatabase.child("MerchantRatings").child(merchantRequest.getMerchantId())
                .child("Number_of_Orders");
        ...
        merchantRequest.setRating(finalRating);
